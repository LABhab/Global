...
tickets = '2114704398:AAEeZesRAMpGMpZDTmwayA9b5-uXlRIHC20' # TOKEN Бота воркера
bot = telebot.TeleBot('2146509723:AAGT9fXWWFRSltugJ4LdU26WXDxw8--1DYk') # TOKEN Бота казино

admin = 2051473697 # ID Админа
support_id = 2051473697 # ID Саппорта
channel_id = -1001745454765 # ID Канала с вылатами
support = '@vvLABvv' # Username Сапорта
